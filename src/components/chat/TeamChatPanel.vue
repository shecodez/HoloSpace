<template>
  <Panel css="w-0 bg-base-100 bg-opacity-80">
    ...
    <div v-if="!$route.params.diskspace_id" class="flex items-center justify-center overflow-hidden">
      <img src="@/assets/branding/brand.png" alt="brand" class="w-11/12 md:w-3/4 lg:w-1/2" />
    </div>
    <template v-else>
      <div v-if="space.id" class="tabs mx-14">
    ...
    <template #footer>
      <div v-if="state.tabs[1].active && $route.params.diskspace_id" class="relative mb-4 mx-6 md:mx-24">
