<template>
  <Layout pageTitle="Privacy Policy">
    <div class="bg-base-300 p-12 overflow-y-auto">
      ...
      <ul>
        <li>
          <p>By email: info+privacy@h010space.com</p>
        </li>
        <!-- <li>
        <p>
          By visiting this page on our website:
          <a
            href="https://h010space.com/contact"
            rel="external nofollow noopener"
            target="_blank"
            >https://h010space.com/contact</a
          >
        </p>
      </li> -->
      </ul>
...
// https://www.termsfeed.com/live/7bb49326-e5be-4207-b45c-d1a78d35d74c
