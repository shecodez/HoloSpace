<template>
  <Layout pageTitle="Terms and Conditions">
    <div class="bg-base-300 p-12 overflow-y-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to H010SPACE.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to H010SPACE, accessible from
            <a href="https://www.h010space.com" rel="external nofollow noopener" target="_blank"
              >https://www.h010space.com</a
            >
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: info+terms@h010space.com</li>
      </ul>
    </div>
  </Layout>
</template>
...
// https://www.termsfeed.com/live/7854788b-409a-45a3-9ea8-8fd0d2cd50ba
...
h2 {
  @apply text-3xl py-2 text-center font-semibold;
}
